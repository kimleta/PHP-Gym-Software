...
include 'config/locationLogic.php';
            ...
            <div class="container-fluid px-4">
                ...
                <?php if ($_GET["id"]) : ?>
                    ...
                    <form class="bg-dark text-light" method="post">
                        ...
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" name="name" class="form-control" id="name" placeholder="Enter Name of package" value="<?= $resultArrayByID[0]["Name"]?>">
                        </div><br>
                        <button type="submit" class="btn btn-primary">Submit</button>
                    </form>
                    <br>
                ...
                <?php if ($_GET["button"] == "delete") : ?>
                    <form class="bg-dark text-light" id="locationForm" method="post">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <a href="?button=add"><button type="button" class="btn btn-primary btn-sm">Add new location</button> </a>
                        <a href="?button=delete"><button type="button" class="btn btn-danger btn-sm">Delete location</button> </a>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table" id="datatablesSimple">
                            ...
                            <tbody>
                                <?php foreach ($resultArray as $result) : ?>
                                    <tr>
                                        <td><?= $result["Name"]; ?></td>
                                        <td><a href="location.php?id=<?= $result["ID"] ?>"><button type="button" class="btn btn-warning btn-sm">Update</button> </a< /td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
